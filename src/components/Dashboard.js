...
const Dashboard =() =>{
    return(
    <div style={{display:"grid", gridTemplateColumns:"5vw repeat(11,1fr)",gridTemplateRows:"repeat(4,25vh)"}}>
        <NavBar className=""/>
        <section style={{gridColumn:"2/-1",display:"grid",gridTemplateColumns:"repeat(12,1fr)",
        gridTemplateRows:"100%",alignItems: "center", borderBottom: "0.1em solid black"}} className="m-5">
