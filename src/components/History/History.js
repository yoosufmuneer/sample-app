...
const History = ({style, username,data}) => {
            ...
            <section className="history_content">
                ...
                {history_items.map((element) =>
                    <div className="history_content_item rounded">
                        ...
                        <p className="mb-0">
                            <a href={`https://www.google.com/maps/@${element.latitude},${element.longtitude},15z`} target="_blank" className="text-decoration-none ">Live Map</a>
                        </p>
                    </div>
                )}
            </section>
